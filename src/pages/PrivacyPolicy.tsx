...
const PrivacyPolicy = () => {
    return (
        ...
        >
            ...
            <p className="mb-4 font-semibold">Torrent Power Limited (TPL) Privacy Policy</p>

            <p className="mb-4">
                Torrent Power Ltd. respects the privacy of everyone who visits this website and is committed to maintain the privacy and security of the personal information of all visitors to the website. Our policy on the collection and use of personal information and other information is outlined below.
            </p>

            <h2 className="text-xl font-semibold mt-8 mb-4">Personal Information</h2>
            <li className="mb-4">
                TPL do not require personal information to obtain access to most of the website.
            </li>

            <li className="mb-4">
                TPL collects personal information from our visitors on a voluntary basis. Personal information may include name, title, company, address, phone number, email address, and other relevant data. Questions or comments submitted by visitors may also include personal information.
            </li>

            <li className="mb-4">
                TPL collect and use personal information for business purposes in order validate your credentials before sharing data specific to your customer service number like Bill Information, Application and complaint details etc. TPL also uses this data to keep you updated on the various services and initiatives being taken by the company. TPL does not share, either within Torrent Power Ltd. or with a third party, any information collected on this website for direct marketing purposes. Given the nature of the World Wide Web, information may be transmitted to another country, , for purposes other than direct marketing, such as for storage, for carrying out the processing detailed above, or because of where our servers are located. To the extent required or permitted by law, TPL may also collect, use and disclose personal information in connection with security related or law enforcement investigations or in the course of cooperating with authorities or complying with legal requirements.
            </li>

            <li className="mb-4">
                TPL may also remove all the personally identifiable information and use the rest for historical, statistical or scientific purposes.
            </li>

            <li className="mb-4">
                If you e-mail us, you are voluntarily releasing information to us. Your e-mail address will be used by Torrent Power Ltd. to respond to you. We will not use the information that can identify you, such as your e-mail address, for direct marketing purposes.
            </li>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Non-Personal Information</h2>
            <li className="mb-4">
            ...
            <li className="mb-4">
                We use the information we automatically receive from your web browser to see which pages you visit within our website, which website you visited before coming to ours, and where you go after you leave. We at Torrent Power Ltd. develop statistics that are helpful to understand how our visitors can use this website. We use this information in the aggregate to measure the use of our website and to administer and improve our website. This statistical data is interpreted by Torrent Power Ltd in its continuing effort to present the website content that visitors are seeking in a format they find most helpful.
            </li>


            <h2 className="text-xl font-semibold mt-8 mb-4">Information Placed on Your Computer</h2>
            <li className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4">Third Parties</h2>

            <li className="mb-4">
                For your convenience, this page may contain certain hyperlinks to other Torrent Power Ltd. group company pages as well as to websites outside Torrent Power Ltd. In addition, you may have linked to our website from another website. We are not responsible for the privacy policies and practices of other websites, even if you access those using links from our website. We can make no promises or guarantees regarding data collection on the hyper-linked pages and on websites that are not owned by Torrent Power Ltd. We recommend that you check the policy of each website you visit, or link from, and contact the owners or operators of such websites if you have any concerns or questions.
            </li>
        </div>
    );
};
